...
var chosen_xAxis = "Crime Rate 2017";
var chosen_yAxis = "TOTAL17";
...
function styleX(value, chosen_xAxis) {
    ...
    //poverty
    if (chosen_xAxis === 'Crime Rate 2017') {
        return `${value}`;
    }
    //income
    else if (chosen_xAxis === 'Crime Rate 2016') {
        return `${value}`;
    }
    //age 
    else {
...
function updateToolTip(chosen_xAxis, chosen_yAxis, circlesGroup) {
    ...
    //poverty
    if (chosen_xAxis === 'Crime Rate 2017') {
        var xLabel = "Crime Rate 17:";
    }
    //household income 
    else if (chosen_xAxis === 'Crime Rate 2016') {
        var xLabel = "Crime Rate 16:";
    }
    //age
    else {
        var xLabel = "Crime Rate 2015:";
    }

    //select y label
    //percentage without healthcare
    if (chosen_yAxis === 'TOTAL17') {
        var yLabel = "Reported Incidents 17:"
    }
    //percentage obese
    else if (chosen_yAxis === 'TOTAL16') {
    ...
    var toolTip = d3.tip()
        ...
        .html(function(d) {
            ...
            return (`${d.State}<br>${yLabel} ${d[chosen_yAxis]}`);
        });
...
d3.csv("./assets/data/CrimeDataSum.csv").then(function(censusDB) {

    console.log(censusDB);

    //parse data
    censusDB.forEach(function(CrimeDataSum) {
        CrimeDataSum.TOTAL17 = +CrimeDataSum.TOTAL17;
        CrimeDataSum.TOTAL16 = +CrimeDataSum.TOTAL16;
        CrimeDataSum.TOTAL15 = +CrimeDataSum.TOTAL15;
    ...
    var povertyLabel = xLabelsGroup.append("text")
        ...
        .attr("x", 0)
        .attr("y", 20)
        .attr("value", "Crime Rate 2017")
        .text("Crime Rate 2017 (per 1,000)");
    ...
    var incomeLabel = xLabelsGroup.append("text")
        ...
        .attr("x", 0)
        .attr("y", 60)
        .attr("value", "Crime Rate 2016")
        .text("Crime Rate 2016 (per 1,000)")
    ...
    var ageLabel = xLabelsGroup.append("text")
        ...
        .attr("x", 0)
        .attr("y", 40)
        .attr("value", "Crime Rate 2015")
        .text("Crime Rate 2015 (per 1,000)")
